...
let target = { XRange = (20,30); YRange = (-10, -5) }
let probe = { Position = (20, 0); Velocity = (0, -2); Alive = true; Hit = false;  YMax = 0 }

target |> TargetArea.isAlive probe
...
let exampleTargetArea = parse example

trace exampleTargetArea (7,2)

let candidates = exampleTargetArea |> TargetArea.candidateVelocities

let boundaries = exampleTargetArea |> TargetArea.initialVelocityBoundaries
candidates |> Seq.tryFind (fun v -> v = (7,2))
